...
import { 
  ...
  Banknote, Receipt, Building2, Landmark
} from 'lucide-react';
...
const FDAccount = () => {
  ...
  const features = [
    {
      ...
      description: "Earn up to 9.0% p.a. with guaranteed returns",
      color: "from-emerald-500 to-emerald-600"
    },
    {
      icon: <Landmark className="w-6 h-6" />,
      title: "Fixed Deposit",
      description: "Secure lump sum investment with guaranteed maturity",
    ...
    },
    {
      ...
      title: "100% Secure",
      description: "Government backed, safe and secure investment",
  ...
  const benefits = [
    {
      ...
      description: "Invest a lump sum for guaranteed high returns",
      stat: "₹10,000+"
    },
    {
      icon: <PiggyBank className="w-5 h-5" />,
      title: "Guaranteed Returns",
      description: "Fixed interest rates with guaranteed maturity amount",
      stat: "Up to 9.0%"
    },
    {
      icon: <Target className="w-5 h-5" />,
      title: "Goal-Based Planning",
      description: "Perfect for long-term wealth creation",
      stat: "Flexible"
    },
    {
  ...
  const faqs = [
    {
      ...
      answer: "The minimum investment amount is ₹10,000, making it accessible for all investors looking for guaranteed returns."
    },
    {
      question: "How is interest calculated on FD?",
      answer: "Interest is calculated on the principal amount and compounded annually. The interest rate varies based on the investment period you choose."
    },
    {
      question: "Can I withdraw my FD before maturity?",
      answer: "Yes, you can withdraw your FD before maturity, but it may be subject to a penalty. Please refer to the account terms and conditions for detailed information."
    },
    {
      question: "Is FD safe and secure?",
      answer: "Yes, Fixed Deposits are one of the safest investment options. They are government backed and regulated by financial authorities."
    },
    {
      question: "Can I have multiple FD accounts?",
      answer: "Yes, you can open multiple FD accounts for different savings goals. Each account can have its own investment amount and tenure."
    }
  ];
  ...
  const handleCalculate = () => {
    if (investmentAmount < 10000) {
      toast.error('Minimum investment amount is ₹10,000');
      return;
    }
    if (investmentAmount > 5000000) {
      toast.error('Maximum investment amount is ₹50,00,000');
      return;
    }
    calculateMaturity();
  };
  ...
  const handleSubmit = (e) => {
    ...
    toast.success('Account opened successfully! Welcome to FD savings.');
    setShowModal(false);
    resetForm();
  };
  ...
  const testimonials = [
    {
      name: "Vikram Singh",
      role: "Business Owner",
      quote: "FD gave me the best returns on my savings. Completely safe and hassle-free!",
      rating: 5
    },
    {
      name: "Anita Desai",
      role: "Senior Citizen",
      quote: "I've been investing in FDs for 10 years. They're the safest and most reliable investment.",
      rating: 5
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-800 dark:via-slate-800 dark:to-slate-800 text-slate-900 dark:text-slate-100">
      <div className="px-4 py-8 mx-auto max-w-7xl sm:px-6 lg:px-8">
          ...
          <div className="relative flex flex-col gap-6 p-8 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className="max-w-2xl mt-3 text-sm text-slate-600 dark:text-slate-400">
                A secure and reliable investment option with guaranteed returns and flexible tenures to help you achieve your financial goals.
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 gap-6 mb-8 md:grid-cols-4">
          {[
            { label: "Min Investment", value: "₹10,000", icon: Banknote, color: "emerald" },
            { label: "Max Interest Rate", value: "9.0% p.a.", icon: Percent, color: "blue" },
            { label: "Tenure", value: "1-5 Years", icon: Calendar, color: "purple" },
            { label: "Compounding", value: "Annual", icon: TrendingUp, color: "amber" }
          ].map((stat, index) => (
            <div 
              key={index}
        ...
        <div className="relative p-8 overflow-hidden shadow-xl bg-gradient-to-r from-[#228296] to-[#6f3c85] rounded-3xl ">
          ...
          <div className="relative flex flex-col items-center justify-between gap-6 md:flex-row">
            <div>
              ...
              <h2 className="text-3xl font-bold text-white">Ready to Grow Your Wealth?</h2>
              <p className="text-white/80">Open your FD account today and enjoy guaranteed returns.</p>
            </div>
            ...
            <div className="px-6 py-6">
              <form onSubmit={handleSubmit}>
                    ...
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <input type="number" name="investmentAmount" value={formData.investmentAmount} onChange={handleInputChange} min="10000" max="5000000" className="w-full pl-10 pr-4 py-2.5 border rounded-lg bg-slate-50 dark:bg-slate-800 border-slate-200 dark:border-slate-700 text-slate-900 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-[#228296]" placeholder="Investment amount" />
                        </div>
                      </div>
                      <div>
                    ...
                    <div className="p-4 border rounded-lg bg-amber-50 dark:bg-amber-900/20 border-amber-200 dark:border-amber-700">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-amber-700 dark:text-amber-400">By opening this account, you agree to the terms and conditions of the FD scheme. Your deposits are secure and regulated by financial authorities.</p>
                        </div>
                      </div>
                    </div>
                ...
                <div className="flex gap-3 pt-6 mt-6 border-t border-slate-200 dark:border-slate-700">
                  {modalStep > 1 && (
                    <button type="button" onClick={prevStep} className="px-6 py-2.5 text-sm font-medium text-slate-700 dark:text-slate-300 bg-slate-100 dark:bg-slate-800 rounded-lg hover:bg-slate-200 dark:hover:bg-slate-700 transition-all duration-300">
                      Previous
                    </button>
                  )}
                  {modalStep < 3 ? (
                    <button type="button" onClick={nextStep} className="flex-1 px-6 py-2.5 text-sm font-medium text-white rounded-lg bg-gradient-to-r from-[#228296] to-[#6f3c85] hover:shadow-lg transition-all duration-300">
                      Next Step
                    </button>
                  ) : (
                    <button type="submit" className="flex-1 px-6 py-2.5 text-sm font-medium text-white rounded-lg bg-gradient-to-r from-[#228296] to-[#6f3c85] hover:shadow-lg transition-all duration-300">
                      Open Account
                    </button>
                  )}
                  <button type="button" onClick={closeModal} className="px-6 py-2.5 text-sm font-medium text-slate-700 dark:text-slate-300 bg-slate-100 dark:bg-slate-800 rounded-lg hover:bg-slate-200 dark:hover:bg-slate-700 transition-all duration-300">
                    Cancel
                  </button>
                </div>
              </form>
