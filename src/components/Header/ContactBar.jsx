...
import { Phone, Mail, IdCard, LogIn, User, X, ChevronDown, Shield, } from "lucide-react";
  ...
  return (
    <>
      <div className="flex flex-wrap items-center justify-between w-full px-10 py-2 mx-auto shadow-md bg-slate-50 lg:px-24 md:px-10">
        ...
        {/* My Sotf Login Button */}
        {/* <div className="flex items-center ml-4">
          <a href="https://ntccsl.nofinofinance.net" target="_blank" rel="noopener noreferrer">
            <button
